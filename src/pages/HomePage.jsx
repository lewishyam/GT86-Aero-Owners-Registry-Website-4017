...
const { FiArrowRight, FiUsers, FiMapPin, FiInstagram } = FiIcons;
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              GT86 Aero Owners Club
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-gray-200">
              <DynamicContent 
                contentKey="homepage_tagline" 
                defaultValue="The Definitive Registry for Toyota GT86 Aero Owners"
              />
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-600 mb-8">
              Connect with fellow GT86 Aero owners worldwide. Share your build, 
              discover modifications, and celebrate the rarest GT86 variant ever made.
            </p>
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                Tag your Instagram posts with <span className="font-semibold text-red-600">#GT86AeroClub</span> 
                to connect with the community and showcase your build.
              </p>
              <a
